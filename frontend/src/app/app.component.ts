...
export class AppComponent implements OnInit {
  ...
  async ngOnInit(){
   ...
   // this.model = await tf.loadGraphModel("https://raw.githubusercontent.com/hugozanini/TFJS-object-detection/master/models/kangaroo-detector/model.json");
  }
    ...
    image.onload =  async () => {
      ...
      this.model.executeAsync(tfimg).then((predictions) => {
        ...
        predictions.forEach((prediction, i) => {
          console.log(i, prediction.arraySync())
        })
